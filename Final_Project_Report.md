...
```
    ...
    ## 
    ##           Mean of squared residuals: 0.01834167
    ##                     % Var explained: 88.35
...
```
    ...
    ## 1  TotalSqFeet 36.84752     42.653416
    ## 2  OverallQual 23.75938     37.239699
    ## 3 Neighborhood 28.68545     20.956949
    ## 4    GrLivArea 18.69674     12.264282
    ## 5    ExterQual 11.08348      9.896118
    ## 6    YearBuilt 10.16437      5.693810
...
```
    ...
    ## The test RMSE is about  -5.25 % different from the train RMSE.
